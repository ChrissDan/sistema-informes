...
app.get('/api/check-inactivos', async (req, res) => {
    ...
    try {
        ...
        informes.forEach(inf => {
            // Aquí la condición es laxa: si hay registro en la tabla informes, cuenta como actividad
            // independientemente de si predicó SI o NO, porque ya hay un registro.
...
app.post('/api/informes', async (req, res) => {
    ...
    // Si horas es 60, permitido es 0. Si horas es 45, permitido es 10.
    ...
    try {
        ...
        // CORRECCIÓN: Si se crea un informe, SIEMPRE marca como 'SI' informó, aunque haya predicado 'NO'.
